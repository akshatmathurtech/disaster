...
import { AlertOctagon, Package, AlertTriangle, LifeBuoy, MapPin, MessageSquare, CheckCircle, ChevronRight } from 'lucide-react';
      ...
      <div className="home-top-bar">
        <div className="app-brand-row">
          <div className="location-pill">
            <MapPin size={14} className="loc-dot" />
      ...
      <div className="home-scroll-body">
        ...
        <div className="sos-hero-card">
          ...
          >
            ...
            <div className="sos-content-box">
              <AlertOctagon size={48} className="sos-icon-glow" />
              <span className="sos-primary-text">SEND SOS DISTRESS SIGNAL</span>
              <span className="sos-sub-text">BROADCASTS YOUR LIVE GPS LOCATION TO COMMAND CENTER</span>
            </div>
          </button>
        </div>
        ...
        <div className="ai-calming-banner" onClick={() => onNavigate('CHAT')}>
          <div className="ai-banner-left">
            <MessageSquare size={24} className="ai-banner-icon" />
            <div>
              <h4>AI Emergency Assistant</h4>
              <p>"I am scared, what should I do?" · Ask questions about surroundings</p>
            </div>
          </div>
          <ChevronRight size={20} className="ai-banner-arrow" />
        </div>
